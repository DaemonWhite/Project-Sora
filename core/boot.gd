...
func _register_ui_manager() -> void:
	# ---- HUD -----
	UiManager.register_ui(&"Notification", "res://ui/hud/notification/notification.tscn", UiManager.LayerType.HUD )
	# ---- GAME MENU ------
	...
	## ---- Debug ------
	UiManager.register_ui(&"TestSelect", "res://ui/hud/test_select/test_select.tscn", UiManager.LayerType.DEBUG)
